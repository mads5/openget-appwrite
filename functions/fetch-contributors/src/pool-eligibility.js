/** Canonical pool ids — keep in sync with distribute-pool/src/pool-types.js */
...
/**
 * Automatic pool eligibility from GitHub-derived signals (v1 rules).
 * @param {{
 *   stars: number;
 *   forks: number;
...
/**
 * Missing or invalid `eligible_pool_types` → all pools (legacy / pre-migration).
 */
