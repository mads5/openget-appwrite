...
const ROWS: {
  ...
  {
    id: "community_match",
    sponsors: "Individuals, small sponsors, broad community backers",
    optimizes: "Broad participation across all listed repos",
    eligibility: "Every listed repo (always included).",
  },
  {
    id: "innovation",
    sponsors: "People who want to help newer projects",
  ...
  },
  {
    ...
    sponsors: "Teams focused on safety and stability",
  ...
  {
    id: "deep_deps",
    sponsors: "Sponsors who want to support core building blocks",
    ...
    <section className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-3 leading-relaxed">
          ...
          pool has its own balance and weekly payout run. When you sponsor, you pick the kind of work you want
          to support.
        </p>
        <p className="text-muted-foreground mt-3 leading-relaxed">
          ...
          <table className="w-full text-sm text-left">
            <thead>
              <tr className="border-b border-border bg-muted/40">
                ...
                <th className="p-3 font-medium min-w-[10rem]">Typical sponsors</th>
            ...
            <tbody>
              {ROWS.map((row) => (
                <tr key={row.id} className="border-b border-border/60 last:border-0">
                  ...
                  <td className="p-3 text-muted-foreground align-top">{row.sponsors}</td>
      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-5 space-y-2 text-muted-foreground leading-relaxed">
          ...
          <li>
            <span className="text-foreground">Governance</span>: Sponsors cannot direct money to specific PRs&mdash;only
      ...
      <div className="space-y-3">
        <h3 className="text-lg font-medium">Which pool should I sponsor?</h3>
        <ul className="list-disc pl-5 space-y-2 text-muted-foreground leading-relaxed">
          <li>
            <span className="text-foreground">Individuals</span> → usually{" "}
            <span className="font-mono text-xs text-primary">community_match</span> (default on the sponsor page).
          </li>
          <li>
      ...
      <p className="text-xs text-muted-foreground leading-relaxed border-t border-border/50 pt-4">
        Pool matching is automatic. Sponsors do not need to review repos one by one.
      </p>
    </section>
  );
}
